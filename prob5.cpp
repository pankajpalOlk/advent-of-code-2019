...
vector<int> calculate(vector<int> vect, int input)
{
    vector<int> result;
    int i = 0;
    ...
    while(true) {
        ...
        int x = (token/100) % 10 == 0 ? vect[vect[i+1]] : vect[i+1];
        int y = (token/1000) % 10 == 0 ? vect[vect[i+2]] :  vect[i+2];
...
int main(int argc, const char * argv[]) {
    ...
    //vector<int> problem1 = calculate(vect, 1);

    vector<int> problem2 = calculate(vect, 5);
    for (int val : problem2) {
        cout << val;
    }
    cout << endl;
